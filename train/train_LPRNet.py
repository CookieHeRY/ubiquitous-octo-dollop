...
def get_parser():
    ...
    parser.add_argument('--train_img_dirs', default=r"F:\machinelearning\project\datasets\ccpd\lpr2\train\images", help='the train images path')
    parser.add_argument('--test_img_dirs', default=r"F:\machinelearning\project\datasets\ccpd\lpr2\test\images", help='the test images path')
    ...
    parser.add_argument('--pretrained_model', default=r'F:\machinelearning\project\YOLOv8-LPRNet-car-plate-recognition\weights\Final_LPRNet_model.pth', help='pretrained base model')
